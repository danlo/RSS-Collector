...
exports.dump = { 
    ...
    run: function() {
        ...
        var self = this;
        client.llen(this.config.redis_config.history_key, function(err, reply) {
...
exports.accept_http_input = {
    ...
    run: function() {
        ...
        client_monitor.on('message', function(channel, message) {
        ...
        console.log('RSS Input Server running at http://' + this.config.http_server_input.host + ':' + this.config.http_server_input.port + '/');
    }
};
...
exports.listener = { 
    ...
    run: function() {
        ...
        console.log('Listening to: ' + this.config.credis_keys.hannel);
    }
};
...
exports.historian = {
    ...
    rss_header: function(res, date) {
        ...
        res.write('<channel>' + "\n");
        res.write('<title>' + self.config.rss.title + '</title>' + "\n");
    ...
    run: function() {
        this.run_save_history();
        this.run_view_history();
    }
};
