...
exports.historian = {
    ...
    view_history: function() {
        ...
        }).listen(this.config.http_server.port, this.config.http_server.host);
        
        console.log('Server running at http://' + this.config.http_server.host + ':' + this.config.http_server.port + '/');
    },
